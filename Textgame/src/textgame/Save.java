...
public class Save {
	...
	write.newLine();
	write.append(Integer.toString(c.HERO_MENTAL));
	write.newLine();
	write.append(Integer.toString(c.HERO_MENTAL_MAX));
	write.newLine();
	write.append(Integer.toString(c.HERO_LV));
	write.newLine();
	write.append(Integer.toString(c.EXP));
	write.newLine();
	write.append(Integer.toString(c.HOUR_DMG));
	write.newLine();
	...
	public void load() throws NumberFormatException, IOException {
		...
		c.HERO_MENTAL = Integer.parseInt(reader.readLine());
		c.HERO_MENTAL_MAX = Integer.parseInt(reader.readLine());
		c.HERO_LV = Integer.parseInt(reader.readLine());
		c.EXP = Integer.parseInt(reader.readLine());
		c.HOUR_DMG = Integer.parseInt(reader.readLine());
